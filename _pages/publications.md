...
* **Jiyoung Park**\*, Jaewook J. Suh\*, Bofan Wang, Anirban Bhattacharya, Shiqian Ma, "Adaptive gradient descent on Riemannian manifolds and its applications to Gaussian variational inference". *ICLR 2026*. [Paper](https://openreview.net/forum?id=2TTQjRkgFn), [Code](https://github.com/wldyddl5510/RAdaGD).
